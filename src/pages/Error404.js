import { secondsLoad } from "../components/secondsLoad";
    ...
    <div class="flex flex-col items-center justify-center px-6 gap-8">
        ...
        <div class="relative flex items-center justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                class="w-16 h-16 text-red-400/90" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="text-center space-y-2 max-w-sm">
            <p class="text-[10px] text-red-400/80 tracking-[0.4em] uppercase font-bold">
              Broken Portal · Error 404
            </p>

            <h2 class="text-5xl font-black text-white tracking-tighter leading-tight">
                Dimension<br />Not Found
            </h2>

            <p class="text-2xs text-slate-300 leading-relaxed pt-1">
                Rick probably blew up the server again.<br />
                Try returning to the correct universe.
            </p>
        </div>
        ...
        <div class="flex items-center gap-3 w-full max-w-xs">
            ...
            <span class="text-[15px] text-slate-100 tracking-widest uppercase">
              Resolving in
              <span class="text-red-400" id="spanCount">${secondsLoad()}</span>
            </span>
