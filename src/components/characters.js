export const characters = () => {
  return `
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-4  lg:m-10 ">
            <a href="src/character/" title="" <div
                style="animation: cardReveal 0.6s cubic-bezier(0.22,1,0.36,1) both; animation-delay: 100 * 100ms"
                ...
                <div class="relative overflow-hidden aspect-square">
                    <img loading="lazy"
                        ...
                        alt="" src="/images/episodes/episode-default.jpg" />
                ...
                <div class="flex flex-col gap-1 px-4 pt-3 pb-4">
                    <span
                        class="font-bold text-white tracking-wide truncate text-sm group-hover:text-green-50 transition-colors duration-200"></span>
                    <span
                        class="text-xs font-semibold text-green-400/80 tracking-widest uppercase group-hover:text-green-300 transition-colors duration-200"></span>
                </div>
            </a>
            <a href="src/character/" title="" <div
                style="animation: cardReveal 0.6s cubic-bezier(0.22,1,0.36,1) both; animation-delay: 100 * 100ms"
