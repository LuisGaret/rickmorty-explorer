...
<section class="py-6 relative min-h-screen overflow-hidden flex items-center" style="
    ...
    <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
      <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 lg:p-10 animate-fadeUp">
        <a href="/" class="inline-flex items-center gap-3 group mb-8">
          <img src="images/icons/logo60x60.png" alt="logo "
  ...
  transition-all duration-300">
            ...
            <div class="w-full aspect-video rounded-lg overflow-hidden bg-black/40">
              <img src="/images/episodes/episode-default.jpg" alt="Personajes" class="w-full h-full object-cover grayscale group-hover:grayscale-0
  ...
  transition-all duration-300">
            <!-- Imagen preview -->
            <div class="w-full aspect-video rounded-lg overflow-hidden bg-black/40">
              <img src="/images/episodes/episode-1.jpg" alt="Episodios" class="w-full h-full object-cover grayscale group-hover:grayscale-0
      scale-105 group-hover:scale-110 transition-all duration-500" />
              <div
                class="absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,0,0,0.15)_2px,rgba(0,0,0,0.15)_4px)]">
              </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <span
                class="text-white/20 group-hover:text-white/60 group-hover:translate-x-0.5 transition-all duration-300 text-lg leading-none">→</span>
            </div>
          </a>
        </div>
      </div>
  ...
  ${characters
    ...
    bg-black/40 border border-white rounded-xl px-4">
      ...
      placeholder-white/40 outline-none text-sm" />
          <button id="searchButton" class="text-white hover:text-green-400 cursor-pointer font-bold text-lg transition">
            Buscar
          </button>
        </div>
        <div class="bg-black/40 border border-white/10 rounded-xl p-5">
          <p class="text-white/50 text-sm leading-relaxed">
            Usa la <span class="text-green-400 cursor-pointer" id="spanFocusSearch">barra de búsqueda</span> para
            encontrar cualquier personaje del universo de Rick & Morty
