export const episodes = () => {
  return `
        <div class="bg-gray-950 font-sans">
            <div class="grid grid-cols-3  gap-4 px-8 lg:px-16 pb-16">
                <a class="group relative block overflow-hidden rounded-xl
             border border-white/4 transition-all duration-500
              hover:-translate-y-2">
                    <div class="relative overflow-hidden" style="aspect-ratio: 16/9;">
                        <img class="w-full h-full object-cover transition-all duration-700 ease-out"
                            alt="" loading="lazy" src="/images/episodes/episode-1.jpg" />
        ...
        transition-colors duration-300 tracking-wide uppercase font-medium">
                            <span class="flex items-center gap-1">
                                <svg class="w-2.5 h-2.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
